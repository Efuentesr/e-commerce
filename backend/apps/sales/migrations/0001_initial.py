# Generated by Django 5.0.6 on 2026-04-09 14:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('creada', 'Creada'), ('aprobada', 'Aprobada'), ('pagada', 'Pagada'), ('anulada', 'Anulada')], db_index=True, default='creada', max_length=20)),
